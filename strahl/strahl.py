...
from source.interface import query, auxillary
from source.interface.editor import (ParameterFileEditor,
                                     InputFileEditor,
                                     SummaryFileEditor)
    ...
    for editor in parameter_editors:
        if editor is not None:
            ...
            if summ_editor.loadable:
                ...
                summ_on, summ_off = auxillary.parameter_lists(sum_param)
            ...
            # set data structure
            file_on, file_off = auxillary.parameter_lists(file_param)
...
def execute(inpt_fns=None, strahl_cmd="./strahl"):
    ...
    if inpt_fns is None:
        auxillary.print_dirContents(os.curdir)
